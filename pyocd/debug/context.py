...
class DebugContext(MemoryInterface):
    ...
    def write_memory(self, addr, value, transfer_size=32, **kwargs):
        return self._parent.write_memory(addr, value, transfer_size, **kwargs)
    ...
    def write_memory_block8(self, addr, value, **kwargs):
        return self._parent.write_memory_block8(addr, value, **kwargs)

    def write_memory_block32(self, addr, data, **kwargs):
        return self._parent.write_memory_block32(addr, data, **kwargs)
    ...
    def read_memory_block32(self, addr, size, **kwargs):
        return self._parent.read_memory_block32(addr, size, **kwargs)
