...
BUILTIN_OPTIONS = [
    ...
    OptionInfo('cortex_m.auto_correct_t_bit', bool, True,
    ...
    OptionInfo('reset.dap_recover_timeout', float, 5.0,
        "Timeout for waiting for the DAP be be accessible after reset. If the timeout lapses, an attempt will be "
        "made to reconnect the DP and retry. Default is 5.0 s."),
    OptionInfo('reset.core_recover_timeout', float, 2.0,
        "Timeout for waiting for a core be be accessible after reset. A warning is printed if the timeout lapes. "
        "Default is 2.0 s."),
