...
#         self.sb_vert.Show(value)
    ...
    def GetShowScrollbars(self):
        """Set True to show scrollbars"""
        return self._sb_show #self.sb_vert.IsShown()
...
#                 self._drawRubberBand(self._zoomCorner1, self._zoomCorner2) # remove old
                ...
                dc.Blit(0, 0, width, height, dcs, 0, 0, wx.COPY)
            else:
    ...
    def _drawRubberBand(self, corner1, corner2):
        ...
        dc = wx.ClientDC( self.canvas )
        dc.BeginDrawing()
        dc.SetPen(wx.BLACK_DASHED_PEN) #wx.Pen(wx.BLACK))
        dc.SetBrush(wx.Brush( wx.BLACK, wx.TRANSPARENT ) )
        dc.SetLogicalFunction(wx.COPY) #INVERT)
    ...
    def _adjustScrollbars(self):
        ...
        self.SetShowScrollbars(self._sb_show) #needScrollbars)
        self._adjustingSB = False
